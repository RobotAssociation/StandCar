...
{ 
	...
	systick_delay_ms(5);
	I2C_WriteAddr(I2C_1, MPU_ADDR, MPU_GYRO_CFG_REG, 3<<3);		// 陀螺仪传感器,±2000dps	// 0,±250dps;1,±500dps;2,±1000dps;3,±2000dps
	systick_delay_ms(5);
	I2C_WriteAddr(I2C_1, MPU_ADDR, MPU_ACCEL_CFG_REG, 2<<3);		// 加速度传感器,±8g		// 0,±2g;1,±4g;2,±8g;3,±16g
	systick_delay_ms(5);
	I2C_WriteAddr(I2C_1, MPU_ADDR, MPU_SAMPLE_RATE_REG, 0X00);	// 设置MPU6050的采样率,1KHz
	systick_delay_ms(5);
	I2C_WriteAddr(I2C_1, MPU_ADDR, MPU_CFG_REG, 0X04);			// 设置数字低通滤波器,20Hz
	systick_delay_ms(10);
